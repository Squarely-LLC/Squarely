...
export type CreditNoteDrawerSubmitPayload = {
  id: number | null;
...
interface Props {
  ...
  editingNote?: CreditNoteRecord | null;
  invoiceOptions: CreditNoteInvoiceOption[];
}

interface Emit {
  (e: "update:isDrawerOpen", value: boolean): void;
  (e: "submit", value: CreditNoteDrawerSubmitPayload): void;
}
...
<template>
  ...
  >
    <AppDrawerHeaderSection
      :title="props.editingNote ? 'Edit Credit Note' : 'Add Credit Note'"
