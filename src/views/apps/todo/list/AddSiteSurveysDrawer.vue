...
const meetingType = ref("Site Visit");
...
const meetingTypeItems = [{ title: "Site Visit", value: "Site Visit" }];
...
async function onSubmit() {
  ...
  // persist to site surveys store
  try {
    siteSurveysStore.addSurvey({
      subject: payload.subject,
      startAt: payload.startAt,
      duration: payload.duration,
      type: payload.type as any,
      linkedTo: payload.linkedTo,
      relatedTo: payload.relatedTo as any,
    ...
    console.warn("Failed to save site survey to store", e);
  }
...
<template>
  ...
  >
    <AppDrawerHeaderSection title="New Site Survey" @cancel="closeDrawer" />
