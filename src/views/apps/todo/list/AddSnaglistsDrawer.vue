...
const meetingTypeItems = [{ title: "Operation", value: "Operation" }];
...
async function onSubmit() {
  ...
  // persist to snaglists store
  try {
    snaglistsStore.addSnag({
    ...
    console.warn("Failed to save snaglist to store", e);
  }
...
<template>
  ...
  >
<AppDrawerHeaderSection title="New Snaglist" @cancel="closeDrawer" />
