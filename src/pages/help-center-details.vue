...
<template>
    <Navbar />
    <div class="mt-10 text-white">.</div>
    <div class="pa-6 help-center-details-wrapper mt-15">
      <VRow>
        <VCol
          cols="12"
          md="8"
          ...
          <VCard>
            ...
            <VCardText>
              ...
              >
                <div class="px-2 pt-2">
                  <iframe
                    src="https://www.youtube.com/embed/ZdJfWjv64Ds"
                    :height="$vuetify.display.mdAndUp ? 440 : 250"
                    class="w-100 rounded youtube-player"
                    frameborder="0"
